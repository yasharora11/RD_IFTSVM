...
# Main experiment
# ---------------------------------------------------
X = load_wpbc("WPBC.xlsx") # Specify the relative path to the WPBC dataset
...
for train_idx, test_idx in kf.split(X):
    ...
    w1, b1 = p5.fit1(A_tr, B_tr, uB, C1, C2)
    w2, b2 = p5.fit2(A_tr, B_tr, uA, C1, C2)
